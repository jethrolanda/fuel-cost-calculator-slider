"use strict";
(self["webpackChunksettings"] = self["webpackChunksettings"] || []).push([["src_components_HubspotSettings_jsx"],{

/***/ "./src/components/HubspotSettings.jsx":
/*!********************************************!*\
  !*** ./src/components/HubspotSettings.jsx ***!
  \********************************************/
...
/* harmony import */ var _store_reducer_hubspotSlice__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../store/reducer/hubspotSlice */ "./src/store/reducer/hubspotSlice.js");
...
const HubspotSettings = () => {
  ...
  let fetched = (0,react_redux__WEBPACK_IMPORTED_MODULE_2__.useSelector)(_store_reducer_hubspotSlice__WEBPACK_IMPORTED_MODULE_1__.loaded);
  let api_key = (0,react_redux__WEBPACK_IMPORTED_MODULE_2__.useSelector)(_store_reducer_hubspotSlice__WEBPACK_IMPORTED_MODULE_1__.apiKey);
  const validateMessages = {
    required: "${label} is required!"
  };
  const formSubmit = values => {
    setLoading(true);
    dispatch((0,_store_reducer_hubspotSlice__WEBPACK_IMPORTED_MODULE_1__.saveHubspotAPIKey)({
      values,
      cb: data => {
        setLoading(false);
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (fetched === false) dispatch((0,_store_reducer_hubspotSlice__WEBPACK_IMPORTED_MODULE_1__.fetchHubspotAPIKey)());
  }, [fetched]);
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    form.setFieldsValue({
      api_key
  ...
  return fetched === false ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(antd__WEBPACK_IMPORTED_MODULE_5__["default"], null) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, contextHolder, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(antd__WEBPACK_IMPORTED_MODULE_6__["default"], {
    orientation: "left",
    orientationMargin: "0"
  }, "Hubspot API Settings"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, "Create api key in hubspot private app. See Link", " ", (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    target: "_blank",
...
/* harmony default export */ __webpack_exports__["default"] = (HubspotSettings);

/***/ })

}]);
//# sourceMappingURL=src_components_HubspotSettings_jsx.js.map