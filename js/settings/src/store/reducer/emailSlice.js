...
export const { setModalActive, setModalFormView, setSpoilerList, setShowConfirm, setSelectedSpoilerId, setSpoilerDeleted, setFetchingSpoiler, setSpoilerAdded, setTotalPages, setTotalItems, setActivePage, setSpoilerToUpdateData } = emailSlice.actions
